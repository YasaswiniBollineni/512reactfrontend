  ...
  return (
    ...
    lg:-mt-24'>
      ...
      <div className='container mx-auto flex flex-col lg:flex-row gap-x-[32px]'>
        ...
        {/*card 3*/}
        <div className='bg-white w-full flex-1 max-w-[542px]
        mx-auto p-[14px] lg:p-[26px] mt-4 lg:-mt-[77px] z-10 shadow-2xl 
        rounded-md flex justify-between items-start' data-aos='fade-up' data-aos-delay='900'>
          {/*card-text*/}
...
<a className='text-xs lg:text-sm font-bold uppercase
text-heading' href='#'>ReadMore</a>
          </div>
          {/*card image*/}
          <div>
