        ...
        <div className="container mx-auto">
            ...
            <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32'> 
                <div className='flex-1 lg:mt-12'> 
                    <h1 className='h1 mb-3 lg:mb-[22px]' data-aos='fade-down'>
                        Yoga to <br />Release Stress
                    </h1>
                       <p className='mb-6 lg:mb-12 max-w-[480px] lg:text-lg'>Yoga is a way of life, rather than a chore.
                          Counteract the stresses of modern life by becoming more mindful and compassionate </p> 
                          {/*btn group */}
                          <div className='mb-12 space-x-4'>
                            <button className='btn btn-sm lg:btn-lg btn-orange'>Get Started</button>
                            <button 
                            className='btn btn-sm lg:btn-lg text-heading bg-transparent border border-stroke-1 px-4 hover:bg-stroke-3 transition'>
                                Learn More
                                </button>
                          </div>
                </div>
