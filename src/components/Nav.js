...
const Nav = () => {
  ...
  return (
    ...
    <nav className="navbar">
      <div className="color=white">Yasaswini Bollineni</div>
     <div><span>Breath & Balance...Inhale Confidence, Exhale Doubt.</span></div>
        <li className="nav-item"><a href="http://localhost:3001/login">Logout</a></li>
