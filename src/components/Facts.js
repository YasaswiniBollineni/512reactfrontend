    ...
    <div className="container mx-auto flex flex-col lg:flex-row lg:gap-x-[30px]">
      ...
      <div className='flex-1 -order-1 lg:order-none'>
        <div className='flex flex-col justify-center h-full lg:pl-[100px]'>
          <h2 className='h2 mb-12 max-w-[295px] md:max-w-none' data-aos='fade-up' data-aos-delay='500'>Relax And Enjoy a Personalized Day Yoga With Us.</h2>
          <div className='mb-2'>
            <img src={Image} alt='' />
          </div>
          <div className='text-lg mb-6 font-bold text-heading'>
            John Cena <span className='text-base text-paragraph font-normal'data-aos='fade-left' data-aos-delay='500'>/Founder</span>
          </div>
        </div>
      </div>
    </div>
